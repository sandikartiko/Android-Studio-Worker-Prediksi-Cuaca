package com.example.tgs6_1918051_worker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void startOneTimeTask() {
        ...
        Data data = new Data.Builder()
                .putString(weathercity.EXTRA_CITY, spCity.getSelectedItem().toString())
                .build();

        Constraints constraints = new Constraints.Builder()
                .setRequiredNetworkType(NetworkType.CONNECTED).build();

        OneTimeWorkRequest oneTimeWorkRequest = new OneTimeWorkRequest.Builder( weathercity.class)
                .setInputData(data)
    ...
    private void startPeriodicTask() {
        ...
        periodicWorkRequest = new PeriodicWorkRequest.Builder(weathercity.class, 15, TimeUnit.MINUTES)
                .setInputData(data)
                .setConstraints(constraints)
                .build();
