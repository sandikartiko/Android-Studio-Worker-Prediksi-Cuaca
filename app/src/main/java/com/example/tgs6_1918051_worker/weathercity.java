...
public class weathercity extends Worker {
    ...
    private static final String TAG = weathercity.class.getSimpleName();
    private Result resultStatus;

    public weathercity(@NonNull Context context, @NonNull WorkerParameters workerParams) {
